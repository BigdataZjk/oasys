...
$('.usershow').popover({
		...
		template: '<div class="popover"><div class="arrow"></div><h3 class="popover-title"></h3><div class="thisdiv" style="border: 0px solid red;min-width: 160px;height: 120px;">'
			...
			+'<tr><td style="padding:4px">Email:</td><td class="thisemail" style="padding:4px">aasadassng@foxmail.com</td></tr>'
			+'</table>	</div></div>'
	});
...
/*外部员工资料版*/
	$('.othershow').popover({
		...
		template: '<div class="popover"><div class="arrow"></div><h3 class="popover-title"></h3><div class="thisdiv" style="border: 0px solid red;min-width: 160px;height: 120px;">'
			...
			+'<tr><td style="padding:4px">Company:</td><td class="thisemail" style="padding:4px">asdwqdang@foxmail.com</td></tr>'
			+'</table>	</div></div>'
	});
